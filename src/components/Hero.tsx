  ...
  return (
    <section className="w-full bg-white">
      <div className="relative w-full overflow-hidden">
        {/* Imagem ocupando a largura total sem container restritivo */}
        <img 
          src="/vivo-banner.png" 
          alt="Banner Vivo Pré" 
        ...
        {/* Posicionamento dos botões ajustado para manter o alinhamento visual */}
        <div className="absolute bottom-[10%] left-[5%] md:left-[10%] lg:left-[15%] flex gap-2 md:gap-4">
